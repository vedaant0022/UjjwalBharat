...
const CategoryCard = () => {
  return (
    <SafeAreaView>
        <View style={{flex:1}}>
            <View>
            <View style={{ backgroundColor: '#ecf1f5', width: moderateScale(118), height: moderateScaleVertical(200), borderRadius: 15 }}>
                    <View style={{ alignItems: 'center', position: 'absolute', left: 0, right: 0, top: -30, }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'flex-start', gap: 8, marginTop:moderateScaleVertical(20) }}>
